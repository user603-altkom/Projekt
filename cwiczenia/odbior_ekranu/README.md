...
1. **Partner sprawdza trzy rzeczy.** FR-002: kwota 50 zł, wykorzystanie 110 zł, limit kredytowy 100 zł, przekroczenie 10 zł. Filtr pokazuje FR-002 i FR-003, a wyłączenie przywraca trzy wiersze. Widok wskazuje, czy liczby pochodzą z demo, czy obliczeń z danych.
...
**Dla szybszych:** sprawdź na kontrolowanej kopii/testowym wejściu limit kredytowy 130 zł: równość nie jest przekroczeniem. Nie nadpisuj oryginalnych danych tylko po to, by poprawić wynik.

## Wyjaśnij pojęcie partnerowi — 60 sekund

Powiedz, do czego przypisany jest limit kredytowy i co porównujemy z nim w tym ćwiczeniu. Wyjaśnij FR-002 bez pomocy AI: skąd 110 zł wykorzystania oraz 10 zł przekroczenia? Na koniec nazwij jedno uproszczenie względem pełnego produktu bankowego. Definicję znajdziesz w [briefie operatora](../../historia/brief_operatora.md).
