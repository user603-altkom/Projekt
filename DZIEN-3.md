...
Obowiązuje [spis ćwiczeń](CWICZENIA.md). Dzień 3 idzie ścieżką cw10b, review przez CLI, cw12b i cw19b (projekt końcowy na własnym repo, z wdrożeniem na Vercel). Wejścia do ćwiczeń są w repo; szablon projektu końcowego jest na github.com, z kopią zip w `cwiczenia/cw19b/`. Godziny to orientacyjna pomoc organizacyjna, na slajdach ich nie ma.
...
| 11:50–12:10 | [cw19b](cwiczenia/cw19b/README.md), setup: klon szablonu, własne repo przez `gh repo create`, zielone Actions, projekt na Vercel, adres produkcyjny szkieletu przed obiadem |
| 12:10–12:55 | Obiad |
...
| 14:00–15:00 | cw19b: `/speckit-implement` faza po fazie, PR na fazę, review, testy; równolegle ekran w Claude Design, faza 4 podpina ekran, produkcja na Vercel; bramka 2 o 15:00, tag v0.1.0 |
| 15:00–15:10 | Przerwa |
| 15:10–15:45 | cw19b: karta zmiany przez proces (test, poprawka, PR, review, merge); bramka 3 o 15:45, tag v0.2.0, mail z linkiem do prowadzącego |
| 15:45–16:05 | Demo: trzy adresy produkcyjne z maili na projektorze, autor opowiada po 5 min: ekran, PR z review, co poprawił |
...
- cw11b (wydanie): wraca skrótowo w cw19b jako merge MVP z tagiem v0.1.0 (bramka 2) i tag v0.2.0 po karcie zmiany (bramka 3). Etapem wydania jest też wdrożenie: repo na GitHubie jest połączone z Vercel, push do main to produkcja, a zaliczenie to mail z adresem działającej aplikacji.
